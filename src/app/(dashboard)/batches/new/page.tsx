  ...
  return (
    <div className="max-w-2xl mx-auto py-6 animate-in fade-in">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Log New Batch</h1>
      </div>

      <Card className="shadow-sm">
        <CardHeader>
          <CardTitle>Batch Details</CardTitle>
          <CardDescription>Enter manufacturing and origin details for the new product batch.</CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="batchNumber" name="batchNumber" required placeholder="BAT-2026-X99" />
              </div>
